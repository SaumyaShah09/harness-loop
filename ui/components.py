    ...
    with gr.Blocks(
        ...
        with gr.Tabs(elem_classes=["edu-tabs"]):
            ...
            with gr.Tab("Playground"):
                ...
                status_bar = gr.Markdown("Ready. Enter a goal and press Start evolution.", elem_id="status-bar")

                gr.HTML('<div class="section-title" style="margin-top: 24px;">Metrics</div>')
